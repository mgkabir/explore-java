...
public class Mongo101 {

   public static void main(final String[] args) {

       // 1. Connect to MongoDB instance running on localhost
       MongoClient mongoClient = new MongoClient("localhost",27117);
       ...
       List<Document> documents = asList(
               ...
               new Document("name","Manoosh Pizza").append("categories", asList("Vegie Pizza", "Meat Pizza")));
    ...
    private static void displayResult(List<Document> results) {
